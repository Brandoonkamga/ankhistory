...
const flashcardsData: Flashcard[] = [
  { question: "Dans la Leçon 1, quel hiéroglyphe numérique égyptien représente l'unité (1) ?", answer: "Le bâton vertical (|), qui symbolise un doigt ou \"l'homme debout\"." },
  { question: "Dans la numération égyptienne, le symbole de l'anse de panier (∩) représente quel nombre ?", answer: "Le nombre 10 (une dizaine)." },
  ...
  { question: "Quel est le concept mathématique clé derrière le fait de grouper 10 unités pour former une dizaine, comme le faisaient les Égyptiens ?", answer: "Le système décimal, ou le principe de \"paqueter\" pour pouvoir compter de grands nombres." },
  { question: "Comment un scribe égyptien lirait-il la séquence ∩∩ ||| ?", answer: "Comme 2 paquets de dix et 3 unités, soit le nombre 23." },
  { question: "Décodez le nombre égyptien suivant en chiffres modernes : ∩∩∩ ||||.", answer: "34." },
  ...
  { question: "L'émotion cible de la leçon sur la numération égyptienne est _____, devant la logique simple de l'écriture.", answer: "l'émerveillement" },
  ...
  { question: "Quelle déesse égyptienne, maîtresse de l'architecture et des mathématiques, est associée à la Leçon 2 ?", answer: "Seshat, la dame des bâtisseurs." },
  ...
  { question: "Quel symbole égyptien est utilisé dans la Leçon 3 pour enseigner les fractions ?", answer: "L'Œil d'Horus (Oudjat)." },
